function[g_Snu,h] = maia_cascadedetection_tuned_ex(data,S_vec,nu_vec,windowsize)
    ...
    nu_0 = 20; 
    %h_0 = 120;
    S_1 = [3e-3,1e-5;1e-5,3e-3];
    %     S_1 = [1.1e-3,6.3e-5;6.3e-5,1.1e-3];
    nu_1 = 9.53;
    %nu_1 = 10;
    %h_1 = 90;
    %S_2 = [3.4e-3,1.6e-5;1.6e-5,2.8e-3];
    S_2 = [7e-3,1e-4;1e-4,6.5e-3];
    %nu_2 = 9.3; 
    nu_2 = 8;
    %h_2 = 90;
    %S_3 = [7.5e-3,-2.0e-3;-2.0e-3,1.2e-2];
         S_3 = [3e-2,2e-3;2e-3,2.5e-2];
        % S_3 = [10e-2,2e-3;2e-3,7e-2];
    nu_3 = 4;
    %h_3 = 90;
    %REV 1
